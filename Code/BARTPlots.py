...
def CompareAverageDayRidersByMonth(hour1, source1, isodow1, month1, year1,
                                   hour2, source2, isodow2, month2, year2):

    plot1 = BARTQueries.GetDailyRidersAveByMonth(hour1, source1, isodow1, month1, year1)
    plot2 = BARTQueries.GetDailyRidersAveByMonth(hour2, source2, isodow2, month2, year2)
